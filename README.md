...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rdfpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12595&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rdfpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rdfpy` can be installed with:

```
conda install rdfpy
```

It is possible to list all of the versions of `rdfpy` available on your platform with:
